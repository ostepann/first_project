...
BASE_LOOKBACK = 30                  # Окно для расчёта момента (доходности за период)
...
BASE_VOL_WINDOW = 8                 # 🔑 Волатильность АКТИВОВ на 9 дней
...
MARKET_VOL_THRESHOLD = 0.30         # 🔑 35% годовой волатильности как порог блокировки
